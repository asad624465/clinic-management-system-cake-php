...
class CarriersTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('carriers_name')
            ->maxLength('carriers_name', 50)
            ->requirePresence('carriers_name', 'create')
            ->notEmptyString('carriers_name');

        $validator
            ->scalar('carriers_code')
            ->maxLength('carriers_code', 50)
            ->requirePresence('carriers_code', 'create')
            ->notEmptyString('carriers_code');
